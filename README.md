...
The repository is structured to support both **topic-wise depth** and **time-wise traceability**.
...
* 🎯 Areas of focus
* 📘 Concepts explored (in my own words)
* 🧪 Experiments or implementations attempted
* ❗ Points of confusion or open questions
* ✅ Key realizations
* ⏭️ Planned next steps

These logs act as checkpoints that reinforce learning and guide future study.
...
* How I break down unfamiliar problems
* How I reason through complexity
* How I learn from mistakes
* How I sustain long-term technical growth
